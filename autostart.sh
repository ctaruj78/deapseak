...
echo -e "  ${CYAN}Admin:${NC}        admin@deapseak.com / admin123"
echo -e "  ${CYAN}Dispatcher:${NC}   dispatcher@deapseak.com / dispatcher123"
echo -e "  ${CYAN}Technician:${NC}   tech@deapseak.com / tech123"
echo -e "  ${CYAN}Client:${NC}       client@deapseak.com / client123"
echo ""
