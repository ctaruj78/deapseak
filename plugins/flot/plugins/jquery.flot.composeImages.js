    ...
    function getGenerateTempImg(tempImg, canvasOrSvgSource) {
        ...
        return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
            ...
            tempImg.onabort = function(evt) {
                ...
                // logger.log('Can\'t generate temp image from ' + tempImg.sourceDescription + '. It is possible that it is missing some properties or its content is not supported by this browser. Source component:', tempImg.sourceComponent);
    ...
    function getCSSRules(document) {
        ...
        for (var i = 0; i < styleSheets.length; i++) {
            ...
            try {
                ...
                // logger.log('Failed to get some css rules');
            }
        }
        return rulesList;
    }
