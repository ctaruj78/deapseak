...
### До виправлення:
```
Пошук по адресі "Київська" → ❌ Немає результатів
...
### Після виправлення:
```
✅ Пошук по адресі "Київська" → Працює!
✅ Пошук по коду "LIFT-123" → Працює!
✅ Пошук по місту "Львів" → Працює!
...
"Київська 25"     → Знайде за адресою
"Львів"           → Знайде всі QR у місті Львів
...
3. **Часткове збігання** - шукає підстроку, не точний збіг
   - "Київ" знайде "Київська", "Київський"
